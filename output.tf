...
output "ap_southeast_2_db_public_ip" { value = ["${aws_instance.ap_southeast_2_db.public_ip}"] }
...
output "ap_southeast_2_db_private_ip" { value = ["${aws_instance.ap_southeast_2_db.private_ip}"] }
